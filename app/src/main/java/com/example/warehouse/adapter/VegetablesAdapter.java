...
public class VegetablesAdapter extends RecyclerView.Adapter<VegetablesAdapter.ViewHolder> {
    ...
    @NotNull
    @Override
    public VegetablesAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.vegetableview,parent,false);
        return new VegetablesAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull VegetablesAdapter.ViewHolder holder, int position) {
        ...
        String disPrice = vegetable_details.getDiscount();
        ...
        vegetableweight = vegetable_details.getWeight_modelClasses();
        ...
        holder.addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                productId = vegetable_details.getId();
        ...
        holder.clicl_product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String productid = vegetable_details.getId();
    ...
    public int getItemCount() {
        return vegetable.size()>4?4:vegetable.size();
    }
