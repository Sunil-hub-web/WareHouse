...
public class ShowAllHomePageProductAdapter extends RecyclerView.Adapter<ShowAllHomePageProductAdapter.ViewHolder> {
    ...
    Context context;
    ArrayList<ShowHomeProduct> product;
    ArrayList<HomeProductWeight> productweight;
    ArrayList<HomeProductImage> productimage;

    String token,str_quantity,productId;
    int quantity;

    public ShowAllHomePageProductAdapter(ViewProductDetails viewProductDetails, ArrayList<ShowHomeProduct> showHomeProduct) {

        this.context = viewProductDetails;
        this.product = showHomeProduct;
    }
    ...
    public ShowAllHomePageProductAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.showhomeproduct,parent,false);
    ...
    public void onBindViewHolder(@NonNull @NotNull ShowAllHomePageProductAdapter.ViewHolder holder, int position) {
        ...
        ShowHomeProduct grocery_details = product.get(position);
        ...
        productweight = grocery_details.getWeight_modelClasses();

       HomeProductSpinerAdapter adapter = new HomeProductSpinerAdapter(context, android.R.layout.simple_spinner_dropdown_item
                , productweight);
